...
"""
TEMPARY INVENTORY SCRIPT
------------------------
* Being Used to work with Ansible Tower, which is runnin a 50-node licensed
* Stops processing system objects after it reaches the 50 limit
"""
